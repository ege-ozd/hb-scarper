...
TR_STOPWORDS = [
    ...
    'ürün', 'ürünü', 'aldım', 'geldi', 'kargo', 'teslim', 'paket', 'paketleme',
    'satıcı', 'sipariş', 'verdim', 'ulaştı', 'elime', 'hepsiburada', 'teşekkürler',
    'teşekkür', 'ederim', 'tavsiye', 'ediyorum', 'teslimat'
]
...
PHRASE_BLOCKLIST = [
    ...
    'gayet başarılı', 'çok memnun kaldım', 'ertesi gün', 'çok fazla', 'sağlam şekilde',
    'onun dışında', 'hak ediyor', 'çok beğendik', 'çok çok', ' ürün çok', 'ürün gayet',
    'ürün gayet güzel', 'kullandıktan sonra', 'mükemmel ürün', 'yaptım çok', 'kullanımı çok',
    'air fryer', 'denedim çok', 'hiç gerek yok', 'gerek yok'


]

def run_tfidf_analysis(input_path, output_path, top_n=100):
    """
